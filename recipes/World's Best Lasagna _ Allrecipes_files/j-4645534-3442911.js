...
(function() {
  ...
  var data = {
    params: window.ftParams_4645534 || '',
    GUID: window.ftGUID_4645534 || '99999999999',
    confID: window.ftConfID_4645534 || '0',
    ftReturn: window.ftReturn_4645534 || '',
    keyword: window.ftKeyword_4645534 || '',
    ftId: window.ftId_4645534 || '',
    imp: window.ftImp4645534,
    ftImpId: window.ftImp4645534 && window.ftImp4645534.impID || '',
    gdpr: window.ftImp4645534 && window.ftImp4645534.gdpr || '',
    gdpr_consent: window.ftImp4645534 && window.ftImp4645534.gdpr_consent || '',
    gdpr_pd: window.ftImp4645534 && window.ftImp4645534.gdpr_pd || '',
    us_privacy: window.ftImp4645534 && window.ftImp4645534.us_privacy || '',
    campaignID: '125231',
    cID: '142671',
    pID: '4645534',
    creativeID: '3442911',
    ...
    extscript: [
      "https://pixel.adsafeprotected.com/jload?anId=930843&advId=&campId=125231&pubId=4207&chanId=4645534&placementId=3442911&adsafe_par&uId=[FT_GUID]&impId=[IMPRESSIONID]"
    ],
    clickTags: [
      "http://servedby.flashtalking.com/click/8/125231;4645534;3442911;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.libertymutual.com/multi-online-quotes?selectedOpt=auto_home&cid=dsp&cmpgncde=2051&keyCode=CMIDBRAN&src=cm-ddis-brd-mem-107113-190415018-4645534"
    ],
    placementDescription: 'T1GEOBroadProspectingPMPMeredith300x600',
    width: 300,
    height: 600,
    ...
    divID: 'ftdiv4645534',
    phID: 'ftpos4645534',
    frameID: 'ftframe4645534',
    expID: 'ftexpframe4645534',
    altImgID: 'ftalt4645534',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'http://servedby.flashtalking.com/click/8/125231;4645534;3442911;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.libertymutual.com/multi-online-quotes?selectedOpt=auto_home&cid=dsp&cmpgncde=2051&keyCode=CMIDBRAN&src=cm-ddis-brd-mem-107113-190415018-4645534',
    altImg: 'http://servedby.flashtalking.com/imp/8/125231;4645534;204;gif;MediaMath;T1GEOBroadProspectingPMPMeredith300x600/?',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/125231;4645534;271;pixel;MediaMath;T1GEOBroadProspectingPMPMeredith300x600/?',
    stump: 'http://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/464/4645534/3442911/js/j-4645534-3442911.js',
    file: 'http://cdn.flashtalking.com/142671/3442911/main.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?211759129-4645534;3442911;',
    adVis: false ? 1 : 0,
    centreAd: true,
    mvt: false,
    segment: window.ftSegment_4645534 || '',
    segmentList: window.ftSegmentList_4645534 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp4645534 && window.ftImp4645534.jsAppend),
    mayExpand: +'0' > 600 || +'0' > 300,
    noBreakout: false,
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m4645534') && /^https:/.test(document.getElementById('ftscript_m4645534').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4645534'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_4645534'],
      ['ftcfid', 'ftConfID_4645534'],
      ['fttime', 'ftTimestamp_4645534'],
      ['ftsection', 'ftSection_4645534'],
      ['ftcustom', 'ftCustom_4645534'],
      ['ft_id', 'ftId_4645534'],
      ['ftimpid', 'ftImp4645534', 'impID'],
      ['gdpr', 'ftImp4645534', 'gdpr'],
      ['gdpr_consent', 'ftImp4645534', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp4645534', 'gdpr_pd'],
      ['us_privacy', 'ftImp4645534', 'us_privacy']
    ]
  };
